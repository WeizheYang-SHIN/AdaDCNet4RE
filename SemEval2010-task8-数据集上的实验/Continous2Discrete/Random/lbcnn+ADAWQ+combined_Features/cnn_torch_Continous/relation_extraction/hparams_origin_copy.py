...
default_pretrained_word_vectors_path = os.path.join(here, '../pretrained_vectors/wiki_100.utf8')
default_train_file = os.path.join(here, '../datasets/ACE_CHN/train.txt')
default_validation_file = os.path.join(here, '../datasets/ACE_CHN/dev.txt')
default_test_file = os.path.join(here, '../datasets/ACE_CHN/test.txt')
default_output_dir = os.path.join(here, '../saved_models')
default_log_dir = os.path.join(default_output_dir, 'runs')
default_tagset_file = os.path.join(here, '../datasets/ACE_CHN/tags.txt')
...
# model
parser.add_argument('--embedding_dim', type=int, default=100, required=False, help='embedding_dim')
parser.add_argument('--dropout', type=float, default=0.2, required=False, help='dropout')
...
parser.add_argument("--max_len", type=int, default=158)
parser.add_argument("--train_batch_size", type=int, default=32)
parser.add_argument("--validation_batch_size", type=int, default=32)
parser.add_argument("--test_batch_size", type=int, default=32)
parser.add_argument("--kernel_size", type=list, default=20)
parser.add_argument("--epochs", type=int, default=300)
parser.add_argument("--learning_rate", type=float, default=1e-5)
parser.add_argument("--weight_decay", type=float, default=0) # 权重衰减，减少过拟合问题
